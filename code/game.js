...
var actorChars = {
  ...
  "=": Lava, "|": Lava, "v": Lava,
  "*": Star, //boosts players speed
  "&": Win //if player touches they win the level   
};
...
var wobbleStarSpeed = 10;
var wobbleStarDist = 0.09;
Star.prototype.act = function(step){
	this.wobble += step * wobbleStarSpeed;
	var wobblePos = Math.sin(this.wobble) * wobbleStarDist;
	this.pos = this.basePos.plus(new Vector (0, wobblePos));	
};

var wobbleWinSpeed = 8 
var wobbleWinDist = 0.07;

Win.prototype.act = function(step) {
  this.wobble += step * wobbleWinSpeed;
  var wobblePos = Math.sin(this.wobble) * wobbleWinDist;
  this.pos = this.basePos.plus(new Vector(0, wobblePos));
};
